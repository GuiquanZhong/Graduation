        ...
        <div class="page-header fade-in-up">
            <div class="header-left">
                ...
                <div class="header-info">
                    ...
                    <p class="page-subtitle">共 {{ total }} 条点赞</p>
                </div>
            </div>
        </div>
...
import { getUserLikes, removeLike, getUserProfile } from '@/api/user'
import { useUserStore } from '@/stores/user'
import { ArrowLeft, Flag, Clock, Delete } from '@element-plus/icons-vue'
...
const pageTitle = computed(() => {
    if (isSelf.value) return '我的点赞'
    return `${targetNickname.value || '用户'}的点赞`
})
...
const loadData = async () => {
    loading.value = true
    try {
        const res = await getUserLikes(userId.value, currentPage.value, pageSize.value)
